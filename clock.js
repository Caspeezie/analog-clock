//create a canvas object from a HTML element
var canvas = document.getElementById('canvas');

//create a 2D drawing object
var ctx = canvas.getContext('2d');

//clock radius by using the height
var radius = canvas.height / 2;

//mapping x and y axis to center of the canvas
ctx.translate(radius, radius);

//reducing clock radius by 90%
radius = radius * 0.90;
...
function drawFace(ctx, radius){
    ...
    //draw grey circle for the face
    ctx.beginPath();
    ctx.arc(0,0,radius,0,2*Math.PI);
    ctx.fillstyle = "Grey";
    ctx.fill();
    
    //create a radial gradient (inner, middle and outer edges of the clock)
